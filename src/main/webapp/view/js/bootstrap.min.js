...
!(function (t, e) {
  ...
  var be = "tooltip",
    ...
    ke = {
      ...
      offset: "(number|string|function)",
      wrapper: "(string|element|boolean)",
    ...
    Be = (function () {
      ...
      return (
        ...
        (t._getwrapper = function () {
          return !1 === this.config.wrapper
            ? document.body
            : _.isElement(this.config.wrapper)
            ? g(this.config.wrapper)
            : g(document).find(this.config.wrapper);
        }),
