...
<script type="text/javascript">
	...
	{
		opener.document.frm.moimZipcode.value=zipcode; //회원주소 우편번호
		opener.document.frm.moimArea1.value=area1; //회원주소 area1(시)
		opener.document.frm.moimArea2.value=area2;//회원주소 area2(구/동)
		self.close();
	}
