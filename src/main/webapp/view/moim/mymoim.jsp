...
<%
	Vector<MoimBean> mymoimList = moimMgr.mymoimList(memberId);	
%>
<!DOCTYPE html>
<html lang="kr">
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.min.js" integrity="sha512-894YE6QWD5I59HgZOGReFYm4dnWc1Qt5NtvYSaNcOP+u1T9qYdvdihz0PPSiiqn/+/3e7Jo4EaG7TubfWGUrMQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
  ...
  <body style = "padding-top: 150px">
    ...
    <!-- 모임리스트 -->
    <%
	if(mymoimList.isEmpty()){
    %>
    <article>
      <div class = "text">
        <!-- class 이름 알잘딱깔센으로 적어보시길... -->
        <p class = "join-text"> <%=memberId %>님이 개설한 모임은 없습니다!</p>
      </div>
    </article>
    <!-- 클래스 리스트 -->
    		<%
    		...
    		<article>
      			<div class = "text">
		        <p class = "join-text"> <%=memberId %>님이 개설한 모임입니다.</p>
 	     		</div>
    		</article>
    		
    		<div class="card-group">
    		<% 
    		for(int i=0;i<mymoimList.size();i++){
    			MoimBean moimbean = mymoimList.get(i);
